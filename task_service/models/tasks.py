...
from task_service.models.base import Base, scoped_session
# from user_service.models.user import Users
...
class Tasks(Base):
    ...
    @classmethod
    def create_task(cls, task_name):
        with scoped_session() as session:
            tasks = Tasks(task_name=task_name)
            session.add(tasks)
